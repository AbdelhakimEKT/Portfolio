...
export default function Contact() {
  ...
  const inputClass =
    'w-full bg-card border border-line rounded-xl px-4 py-3 text-heading text-sm focus:outline-none focus:border-brand/50 transition-colors duration-300 placeholder:text-faded/50'
          ...
          <ScrollReveal className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block text-sm text-faded mb-2">
                    Nom complet *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm text-faded mb-2">
                    Email *
                  </label>
                  <input
                    type="email"
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="phone" className="block text-sm text-faded mb-2">
                    Téléphone
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="projectType" className="block text-sm text-faded mb-2">
                    Type de projet
                  </label>
                  <select
                    id="projectType"
              ...
              <div>
                <label htmlFor="message" className="block text-sm text-faded mb-2">
                  Votre message *
                </label>
                <textarea
                  id="message"
              ...
              <button
                type="submit"
                className="bg-brand hover:bg-brand-hover text-white font-medium px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 text-sm w-full sm:w-auto"
              >
          ...
          <ScrollReveal className="lg:col-span-2" delay={0.2}>
            <div className="space-y-6">
              <div className="bg-card rounded-2xl p-6 border border-line">
                <h3 className="text-heading font-semibold mb-6">
                ...
                <div className="space-y-5">
                  <a
                    ...
                    className="flex items-center gap-4 text-faded hover:text-green-500 transition-colors duration-300 group"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 text-faded hover:text-brand transition-colors duration-300 group"
                  >
                    <div className="w-10 h-10 rounded-full bg-brand/10 flex items-center justify-center group-hover:bg-brand/20 transition-colors duration-300">
                  ...
                  <a
                    href="tel:0768636649"
                    className="flex items-center gap-4 text-faded hover:text-heading transition-colors duration-300 group"
                  >
                    <div className="w-10 h-10 rounded-full bg-faded/10 flex items-center justify-center group-hover:bg-faded/20 transition-colors duration-300">
